...
exports.testChampionshipPerformance = testChampionshipPerformance;
const championship_tools_1 = require("./handlers/championship-tools");
...
async function testChampionshipPerformance() {
    ...
    console.log('=====================================\n');
    const handler = new championship_tools_1.ChampionshipToolHandler();
    const results = [];
    let passCount = 0;
    let failCount = 0;
    // Get all tools
 ...
 */
function createTestArgs(toolName) {
...
//# sourceMappingURL=test-all-functions.js.map