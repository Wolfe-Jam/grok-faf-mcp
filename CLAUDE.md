...
- **When:** Shipped 2026 — current v1.8.1 (patch: symmetric .fafm refresh receipts — refresh_fafm now writes .fafm-refresh-receipts.json; no surface change; inherits The Closed-Loop Edition). v1.8.0 The Closed-Loop Edition (observability write-paths + canonical token engine + FRC flag-gate contract); v1.7.0 The Grounded Memory Edition (ZEPH + FRC over Grok Collections); v1.6.0 ZEPH Edition; v1.5.5 Glama Core-tier.
