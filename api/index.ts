...
<body>
  ...
  <div class="container">
    ...
    <div style="display:flex;justify-content:center;margin:1.5rem 0;">
      ...
      <a href="https://faf-voice.vercel.app/agent" style="margin-left:5px;display:inline-flex;align-items:center;height:20px;padding:0 18px;background:#00D4D4;color:#000;font-weight:600;font-size:0.72rem;border-radius:6px;text-decoration:none;font-family:-apple-system,BlinkMacSystemFont,sans-serif;">Chat to FAFA live &rarr;</a>
    </div>
