...
exports.isCoreTool = isCoreTool;
exports.isAdvancedTool = isAdvancedTool;
exports.getCoreTools = getCoreTools;
exports.getAdvancedTools = getAdvancedTools;
exports.getAllTools = getAllTools;
exports.getToolsByCategory = getToolsByCategory;
exports.getToolMetadata = getToolMetadata;
exports.validateToolCounts = validateToolCounts;
/**
 ...
 * Helper functions
 */
function isCoreTool(toolName) {
    return exports.TOOL_REGISTRY[toolName]?.visibility === 'core';
}
function isAdvancedTool(toolName) {
    return exports.TOOL_REGISTRY[toolName]?.visibility === 'advanced';
}
function getCoreTools() {
    return Object.values(exports.TOOL_REGISTRY).filter((tool) => tool.visibility === 'core');
}
function getAdvancedTools() {
    return Object.values(exports.TOOL_REGISTRY).filter((tool) => tool.visibility === 'advanced');
}
